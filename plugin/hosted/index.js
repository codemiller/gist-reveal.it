...
var opts = {
  ...
  socket_host: process.env.REVEAL_SOCKET_HOST || process.env.REVEAL_WEB_HOST || process.env.OPENSHIFT_APP_DNS || process.env.GIST_REVEAL_SERVICE_SERVICE_HOST || 'localhost',
